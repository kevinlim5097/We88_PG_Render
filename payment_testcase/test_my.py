...
from new_config import BASE_URL_MY, headless, my_close_all_popups_and_chat, my, check_visible_text_for_errors
...
class TestChromiumBrowser(unittest.IsolatedAsyncioTestCase):
    ...
    async def login(self):
        """执行登录操作"""
        await self.page.goto(BASE_URL_MY)
    ...
    async def test_my(self):
        await my_close_all_popups_and_chat(self.page)
        await self.page.click('button.ewallatbtn')
        await self.page.wait_for_timeout(1000)
        print('...Start Testing Malaysia Crypto Deposit...')
        ...
        print("--------------------MY Crypto Testing Done--------------------\n")

        print('...Start Testing Malaysia Fast Deposit...')
        await self.page.click('button.ewallatbtn')
        await self.page.wait_for_timeout(1000)
        ...
        print("--------------------MY Fast Deposit Testing Done--------------------\n")
